...
<div className="hero min-h-screen bg-base-200">
  <div className="hero-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
    <div className="text-center lg:text-left text-white leading-relaxed">
      ...
      <p className="py-6 w-2/3 md:w-full text-lg mx-auto">I am interested in full time Web Developer roles, Freelance opportunities or opportunities to work in a Start-Up.
      <br />
